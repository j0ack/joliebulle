...
from mashDetail_ui import Ui_DialogMashDetail
...
class DialogMashDetail(QtWidgets.QDialog):
    ...
    def setFields(self, currentMash):
        self.ui.labelMashName.setText(
            '''<p align="center"><b>''' + currentMash.name + '''</b></p>''')
        ...
        for step in currentMash.listeSteps:
            ...
            stepDetail = QtGui.QLabel("{}, {}°C, {}{}".format(
                step.type, step.temp, step.time, self.tr(" min")
            ))
